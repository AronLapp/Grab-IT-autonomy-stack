...
Once the hardware is up and running, a RaspberryPi5 computing unit running ubuntu 24.04 Server and ROS2 Jazzy will be added to implement Moveit Control and autonomous behavior control.
